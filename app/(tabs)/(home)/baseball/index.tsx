...
const SAMPLE_GOALS: Goal[] = [
  { id: "g1", name: "Hitting Reps", done: 60, total: 200 },
  { id: "g2", name: "Throwing Drills", done: 2, total: 4 },
  { id: "g3", name: "Fielding Reps", done: 80, total: 250 },
];
...
export default function BaseballHome() {
  ...
  const totals = useMemo(
    () => ({ reps: 912, workouts: 7, growthFrom: 9, growthTo: 15 }),
    [interval, query]
  );
  ...
  return (
    ...
    >
      ...
      {/* Weekly (same palette/structure as Football) */}
      <LinearGradient
      ...
      <View style={{ gap: 20, marginTop: 12 }}>
        ...
        <View style={styles.bigCard}>
          ...
          <View style={styles.bigContent}>
            ...
            <Pressable style={{ alignSelf: "flex-start", marginTop: 12 }} onPress={() => router.push("/(tabs)/(home)/baseball/add-game")}>
        ...
        <View style={styles.bigCard}>
          ...
          <View style={styles.bigContent}>
            ...
            <Pressable style={{ alignSelf: "flex-start", marginTop: 12 }} onPress={() => router.push("/(tabs)/(home)/baseball/add-practice")}>
              <LinearGradient colors={[theme.colors.primary600, "#3BAA6F"]} start={{ x: 0, y: 0 }} end={{ x: 1, y: 1 }} style={styles.cta}>
