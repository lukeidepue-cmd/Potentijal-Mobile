// app/(tabs)/(home)/running/weekly-goals.tsx
...
import ProgressBar from "../../../../components/ProgressBar";  // default export

type Goal = { id: string; label: string; pct: number };
const uid = () => Math.random().toString(36).slice(2, 9);

export default function RunningWeeklyGoalsScreen() {
  const [goals, setGoals] = useState<Goal[]>([
    { id: uid(), label: "10 miles", pct: 0.4 },
    { id: uid(), label: "Better than 7:50 pace", pct: 0.0 },
  ]);
            ...
            {goals.map((g) => {
              ...
              return (
                <View key={g.id} style={{ gap: 6 }}>
                  ...
                  {/* Only props supported by ProgressBar: value (+ optional height) */}
