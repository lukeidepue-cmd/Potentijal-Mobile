...
const SAMPLE_GOALS: Goal[] = [
  { id: "g1", name: "Skating Minutes", done: 15, total: 60 },
  { id: "g2", name: "Shooting Reps", done: 90, total: 250 },
  { id: "g3", name: "Stickhandling Touches", done: 120, total: 300 },
];
      ...
      <View style={{ gap: 20, marginTop: 12 }}>
        <View className="bigCard" style={styles.bigCard}>
          ...
          <View style={styles.bigContent}>
            ...
            <Pressable style={{ alignSelf: "flex-start", marginTop: 12 }} onPress={() => router.push("/(tabs)/(home)/hockey/add-game")}>
        ...
        <View style={styles.bigCard}>
          <Image source={require("../../../../assets/players/mcdavid.jpg")} style={styles.heroImageTop} resizeMode="cover" />
          <View style={styles.bigContent}>
            <Text style={styles.bigTitle}>Log Team Practices</Text>
            <Text style={styles.bigSub}>To Add Additional Training</Text>
            <Pressable style={{ alignSelf: "flex-start", marginTop: 12 }} onPress={() => router.push("/(tabs)/(home)/hockey/add-practice")}>
              <LinearGradient colors={[theme.colors.primary600, "#3BAA6F"]} start={{ x: 0, y: 0 }} end={{ x: 1, y: 1 }} style={styles.cta}>
