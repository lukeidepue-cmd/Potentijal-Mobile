// app/(tabs)/(home)/hockey/add-practice.tsx
import React from "react";
import { View, Text, Pressable } from "react-native";
import { router } from "expo-router";
import { theme } from "../../../../constants/theme";

export default function HockeyAddPractice() {
  return (
    <View style={{ flex: 1, backgroundColor: theme.colors.bg0, padding: theme.layout.xl, gap: 12 }}>
      <Text style={{ color: theme.colors.textHi, fontSize: 22, fontWeight: "900" }}>Add Team Practice (Hockey)</Text>
